...
class Progression(Serializable):
    ...
    def get_level_mobs(self):
        ...
        if self._level == 1:
            ...
            squelette1 = Skeleton(random.choice(random_skeleton_names), 7, 3, 0, Dice(3))
            ...
            phantom1 = Phantom(random.choice(random_phantom_names), 15, 10, 0, Dice(6))
            phantom2 = Phantom(random.choice(random_phantom_names), 15, 10, 0, Dice(6))
            ...
            phantom1 = Phantom(random.choice(random_phantom_names), 20, 10, 3, Dice(7))
            level_mobs.append(zombie1)
            level_mobs.append(ogre1)
            level_mobs.append(golem1)
            level_mobs.append(phantom1)
